import { DomSanitizer } from './chunk-AY5GO2BG.js';
import './chunk-BENUO3ZQ.js';
import { DOCUMENT } from './chunk-YJMNELJC.js';
import {
  Component,
  Directive,
  ElementRef,
...
function _wrapRegExp() {
  ...
  return (
    ...
    (BabelRegExp.prototype.exec = function (r3) {
...
var IS_DOM =
  ...
  !!DOCUMENT2.head &&
  typeof DOCUMENT2.addEventListener === 'function' &&
  typeof DOCUMENT2.createElement === 'function';
...
var ma = [
  ...
  .concat(c$1.map(a => ''.concat(a, 'x')))
  .concat(F$1.map(a => 'w-'.concat(a)));
var wa = {
  'Font Awesome 5 Free': {
    900: 'fas',
    400: 'far',
...
_PREFIX_TO_STYLE[s] = _objectSpread2(
  _objectSpread2(
    _objectSpread2(
      _objectSpread2(
        {},
...
_STYLE_TO_PREFIX[s] = _objectSpread2(
  _objectSpread2(
    _objectSpread2(
      _objectSpread2(
        {},
...
function getCanonicalIcon(values) {
  ...
  const canonical = _objectSpread2(
...
var newCanonicalStyles = Object.keys(ga)
  .filter(key => key !== s)
  .map(key => Object.keys(ga[key]))
  .flat();
...
var autoReplace = function () {
  let params = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
  const { autoReplaceSvgRoot = DOCUMENT2 } = params;
...
function asIcon(_ref) {
  let { children, main, mask, attributes, styles: styles2, transform } = _ref;
...
function makeInlineSvgAbstract(params) {
  ...
  const attrClass = [config.replacementClass, iconName ? ''.concat(config.cssPrefix, '-').concat(iconName) : '']
    .filter(c$$1 => extra.classes.indexOf(c$$1) === -1)
    .filter(c$$1 => c$$1 !== '' || !!c$$1)
...
function observe(options) {
  ...
  const { treeCallback = noop$2, nodeCallback = noop$2, pseudoElementsCallback = noop$2, observeMutationsRoot = DOCUMENT2 } = options;
...
function onTree(root) {
  ...
  const prefixesDomQuery = ['.'.concat(LAYERS_TEXT_CLASSNAME, ':not([').concat(DATA_FA_I2SVG, '])')]
    .concat(prefixes.map(p$$1 => '.'.concat(p$$1, ':not([').concat(DATA_FA_I2SVG, '])')))
    .join(', ');
...
var ReplaceElements = {
  ...
  provides(providers$$1) {
    providers$$1.i2svg = function (params) {
      const { node = DOCUMENT2, callback = () => {} } = params;
    ...
    providers$$1.generateAbstractIcon = function (_ref2) {
      let { children, attributes, main, transform, styles: styles2 } = _ref2;
      const styleString = joinStyles(styles2);
      if (styleString.length > 0) {
        attributes['style'] = styleString;
      }
...
var MissingIconIndicator = {
  provides(providers2) {
    ...
    providers2.missingIconAbstract = function () {
      ...
      const OPACITY_ANIMATE = _objectSpread2(
...
var isKnownRotateValue = rotate =>
  rotate != null && (rotate === 90 || rotate === 180 || rotate === 270 || rotate === '90' || rotate === '180' || rotate === '270');
  ...
  static {
    this.ɵfac = function FaIconComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _FaIconComponent)(
        ɵɵdirectiveInject(DomSanitizer),
        ɵɵdirectiveInject(FaConfig),
        ɵɵdirectiveInject(FaIconLibrary),
        ɵɵdirectiveInject(FaStackItemSizeDirective, 8),
        ɵɵdirectiveInject(FaStackComponent, 8)
      );
    };
  }
  static {
...
var FaDuotoneIconComponent = class _FaDuotoneIconComponent extends FaIconComponent {
  findIconDefinition(i) {
    ...
    if (definition != null && !Array.isArray(definition.icon[4])) {
      throw new Error(
        `The specified icon does not appear to be a Duotone icon. Check that you specified the correct style: <fa-duotone-icon [icon]="['fad', '${definition.iconName}']"></fa-duotone-icon> or use: <fa-icon icon="${definition.iconName}"></fa-icon> instead.`
      );
    }
    return definition;
  }
  ...
  static {
    this.ɵfac = /* @__PURE__ */ (() => {
      ...
      return function FaDuotoneIconComponent_Factory(__ngFactoryType__) {
        return (ɵFaDuotoneIconComponent_BaseFactory || (ɵFaDuotoneIconComponent_BaseFactory = ɵɵgetInheritedFactory(_FaDuotoneIconComponent)))(
          __ngFactoryType__ || _FaDuotoneIconComponent
        );
      };
    })();
  }
