...
import { Subject } from './chunk-ZSY7TSMJ.js';
...
function parseNumberFormat(format, minusSign = '-') {
  ...
  const positiveParts =
      positive.indexOf(DECIMAL_SEP) !== -1
        ...
        : [positive.substring(0, positive.lastIndexOf(ZERO_CHAR) + 1), positive.substring(positive.lastIndexOf(ZERO_CHAR) + 1)],
...
var provideCloudinaryLoader = createImageLoader(
  createCloudinaryUrl,
  ngDevMode ? ['https://res.cloudinary.com/mysite', 'https://mysite.cloudinary.com', 'https://subdomain.mysite.com'] : void 0
);
...
function createNetlifyUrl(config, path) {
  ...
  for (const [param, value] of Object.entries(config.loaderParams ?? {})) {
    if (validParams.has(param)) {
      ...
      if (ngDevMode) {
        console.warn(
          formatRuntimeError(2959, `The Netlify image loader has detected an \`<img>\` tag with the unsupported attribute "\`${param}\`".`)
        );
      }
    }
  }
...
var NgOptimizedImage = class _NgOptimizedImage {
  ...
  static ɵdir = ɵɵdefineDirective({
    ...
    hostBindings: function NgOptimizedImage_HostBindings(rf, ctx) {
      if (rf & 2) {
        ɵɵstyleProp('position', ctx.fill ? 'absolute' : null)('width', ctx.fill ? '100%' : null)('height', ctx.fill ? '100%' : null)(
          'inset',
          ctx.fill ? '0' : null
        )('background-size', ctx.placeholder ? 'cover' : null)('background-position', ctx.placeholder ? '50% 50%' : null)(
          'background-repeat',
          ctx.placeholder ? 'no-repeat' : null
        )('background-image', ctx.placeholder ? ctx.generatePlaceholder(ctx.placeholder) : null)(
          'filter',
          ctx.placeholder && ctx.shouldBlurPlaceholder(ctx.placeholderConfig) ? 'blur(15px)' : null
        );
      }
    },
    inputs: {
...
@angular/common/fesm2022/common.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-YJMNELJC.js.map
