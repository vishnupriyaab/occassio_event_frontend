import { withHttpTransferCache } from './chunk-HK5MR6SF.js';
import {
  CommonModule,
  DOCUMENT,
  DomAdapter,
...
import { __spreadProps, __spreadValues } from './chunk-5TID76VL.js';
  ...
  sanitize(ctx, value) {
    ...
    switch (ctx) {
      ...
      case SecurityContext.RESOURCE_URL:
        ...
        throw new RuntimeError(
          5201,
          (typeof ngDevMode === 'undefined' || ngDevMode) && `unsafe value used in a resource URL context (see ${XSS_SECURITY_URL})`
        );
      default:
        throw new RuntimeError(
          5202,
          (typeof ngDevMode === 'undefined' || ngDevMode) && `Unexpected SecurityContext ${ctx} (see ${XSS_SECURITY_URL})`
        );
    }
  }
...
@angular/platform-browser/fesm2022/platform-browser.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-OB3TT5QY.js.map
